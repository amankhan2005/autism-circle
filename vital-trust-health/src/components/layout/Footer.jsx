...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#155E54] text-white relative overflow-hidden border-t border-white/10">
      ...
      <Container>
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 relative z-10">
          ...
          <div className="lg:col-span-4">
            ...
            {/* <div className="flex gap-3">
              <a
                ...
                className="h-10 w-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-[#F97316] hover:scale-110 transition-all duration-300"
          ...
          <div className="lg:col-span-2">
            <h3 className="text-lg font-semibold mb-5 text-white relative before:absolute before:left-0 before:-bottom-1 before:w-8 before:h-[3px] before:bg-[#F97316]">
              Quick Links
            </h3>
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.path}>
                  <Link
                    className="text-sm text-white/70 hover:text-orange-400 hover:pl-2 transition-all duration-300 inline-block"
                    to={link.path}
                  >
                    {link.name}
                  </Link>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 group">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sm text-white/70 hover:text-white transition block"
                >
        ...
        {/* Bottom Bar */}
        <div className="border-t border-white/10 py-6 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-white/50">
          <p>
