...
const issues = [
  { icon: <IconVideo />, title: "Anxiety & Stress" },
  { icon: <IconChat />, title: "Depression" },
  { icon: <IconHeart />, title: "Relationship Issues" },
  { icon: <IconGlobe />, title: "Work-Life Balance" },
  { icon: <IconDeviceMobile />, title: "Emotional Support" },
  { icon: <IconSparkles />, title: "Personal Growth" },
];
...
const benefits = [
  {
    icon: <IconGlobe />,
    title: "Convenience",
    desc: "Attend sessions from anywhere—home, office, or on the go. No travel required.",
  },
  {
    icon: <IconLock />,
    title: "Privacy",
    desc: "Get support in a comfortable, private space with secure, encrypted connections.",
  },
  {
    icon: <IconClock />,
    title: "Flexible Timing",
    desc: "Schedule sessions that fit your lifestyle, including evenings and weekends.",
  },
];
...
const faqs = [
  {
    ...
    a: "Yes. Research shows that online therapy is just as effective as in-person sessions for many conditions, including anxiety, depression, and stress.",
  },
  {
    q: "Is the platform secure and confidential?",
    a: "Absolutely. We use HIPAA-compliant, encrypted video platforms to ensure your privacy is protected at all times.",
  },
  {
      ...
      >
        ...
        <Container className="relative z-10 text-center">
          ...
          <p className="max-w-2xl mx-auto text-lg text-white/80 leading-relaxed mb-8" data-aos="fade-up" data-aos-delay="100">
            Access professional mental health support from the comfort of your home with secure and flexible online therapy sessions.
          </p>
          <Link
            to="/contact-us"
      ...
      <Container>
        ...
        <div className="lg:-mt-20 relative z-10 mb-24">
          <div className={`grid lg:grid-cols-2 gap-16 items-center rounded-3xl shadow-2xl overflow-hidden p-8 md:p-12 transition-colors duration-300 ${
            ...
            <div className="relative" data-aos="fade-right">
              ...
              <img
                src="/images/services/online-counseling.jpg"
            ...
            <div data-aos="fade-left">
              ...
              <p className={`mb-4 leading-relaxed ${isDark ? "text-gray-400" : "text-slate-600"}`}>
                Online counseling allows you to connect with licensed therapists through secure video calls, chats, or phone sessions from anywhere.
              </p>
              <p className={`mb-8 leading-relaxed ${isDark ? "text-gray-400" : "text-slate-600"}`}>
                It offers the same level of professional care as in-person sessions while providing greater flexibility and comfort.
              </p>

              {/* Features Checklist */}
              <ul className="space-y-3">
                {["HIPAA-Compliant Video Platform", "Easy Scheduling & Reminders", "Access from Any Device"].map((item, i) => (
        ...
        <div className="py-16 relative">
          <div className="text-center mb-12">
            ...
            <p className={`max-w-xl mx-auto ${isDark ? "text-gray-400" : "text-slate-600"}`} data-aos="fade-up" data-aos-delay="50">
              We treat a wide range of mental health concerns remotely.
            </p>
          </div>
        ...
        <div className="py-16">
          <div className={`rounded-3xl p-8 md:p-12 transition-colors duration-300 ${
            ...
            <div className="text-center mb-12">
              <h2 className={`text-3xl font-bold ${isDark ? "text-white" : "text-slate-800"}`}>Benefits of Online Therapy</h2>
            </div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/90 mb-8 max-w-xl mx-auto">
                Start your journey towards better mental health today from the comfort of your own space.
              </p>
              <Link
                to="/contact-us"
